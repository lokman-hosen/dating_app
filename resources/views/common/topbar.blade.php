                ...
                <div class="m-stack m-stack--ver m-stack--general">
                    <div class="m-stack__item m-stack__item--middle m-brand__logo">
                        <a href="" class="m-brand__logo-wrapper">
                            <img alt="" src="https://preview.keenthemes.com/metronic/theme/html/demo1/dist/assets/media/logos/logo-light.png" >
                            {{-- <h3>NEMC</h3>--}}
                        </a>
                    </div>
                                ...
                                <div class="m-dropdown__wrapper" style="left: -5rem !important;">
                                    ...
                                    <div class="m-dropdown__inner">
                                        <div class="m-dropdown__header m--align-center" style="background-color: #56bfa399;">
                                            <span class="m-dropdown__header-title">5 New Notification</span>
                                                                ...
                                                                <div class="m-list-timeline__items notification-detail">
                                                                        ...
                                                                        <a class="" href="">
                                                                            <div class="m-list-timeline__item">
                                                                                ...
                                                                                <span class="m-list-timeline__time">Message</span>
                                                                            </div>
                                                                        </a>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="m-dropdown__body">
                                            <div class="m-dropdown__content">
                                                    <ul class="m-nav m-nav--skin-light">
                                                        ...
                                                        <li class="m-nav__item">
                                                            <a href="{{ route('logout') }}" class="btn m-btn--pill btn-block btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder"
